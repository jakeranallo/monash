...
module.exports = function($, _) {
  ...
  // Submit form to Webflow // hacked by xaun //****
  function submitWebflow(data) {
    ...
    ////// iterate through localStorage and apply cached data to payload.fields //////****
    var cacheKeys = Object.keys(window.localStorage).sort();
    for (var i = 0; i < cacheKeys.length; i++)
    {
      var cacheKey  = cacheKeys[i],
          cacheData = JSON.parse(window.localStorage.getItem(cacheKey));
      ...
      {
        payload.fields[cacheData[k].name] = cacheData[k].value;
      }
    }
  ...
  function afterSubmit(data) {
    ...
    if (success && redirect) {
      console.log('redirecting...', Webflow.location);
...
Webflow.require('ix').init([
  {"slug":"fadeout","name":"fadeOut","value":{"style":{},"triggers":[{"type":"load","preload":true,"stepsA":[{"wait":500},{"opacity":0,"transition":"opacity 500ms ease 0ms"},{"display":"none"}],"stepsB":[]}]}},
